<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NoInjection.aspx.cs" Inherits="SearchCurrentBugs" %>
      ...
      <div style="text-align:center;">
        <asp:Panel ID="Panel1" runat="server" Width="70%">
          <div style="text-align:left;">
            About &nbsp <%=Request["dealMan"]%> Search Condition (Querying by sql)
          </div>
