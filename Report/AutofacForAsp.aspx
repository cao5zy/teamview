<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AutofacForAsp.aspx.cs" Inherits="SearchCurrentBugs" %>
      ...
      <div style="text-align:center;">
        <asp:Panel ID="Panel1" runat="server" Width="70%">
          <div style="text-align:left;">
            About &nbsp<%=Request["dealMan"]%> Search Condition (using Autofac in Web form)
          </div>
